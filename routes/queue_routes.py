...
from services.approval_service import get_pending, approve, reject, edit_and_send, update_draft
...
def save_draft_reply(
    ...
    if not draft_body:
        raise HTTPException(status_code=400, detail="Body is required")
    return update_draft(queue_id=queue_id, draft_body=draft_body)